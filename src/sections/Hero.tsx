  ...
  return (
    <section className="py-32 md:py-48 lg:py-60 relative z-0 overflow-x-clip">
      <div className='absolute inset-0 [mask-image:linear-gradient(to_bottom,transparent,black_10%,black_70%,transparent)] '>
        ...
        <div className='size-[620px] rings'></div>
        <div className='size-[820px] rings'></div>
        <div className='size-[1020px] rings'></div>
        <div className='size-[1220px] rings'></div>
      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col items-center">
          ...
          <div className="flex flex-col md:flex-row justify-center items-center mt-8 gap-4">
            <button className="inline-flex items-center gap-2 border border-white/15 h-12 px-6 rounded-xl text-white">
